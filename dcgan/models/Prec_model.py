...
wandb.init(project="dcgan_mnist", name="Prec_DCGAN", job_type="training")
...
train_images = train_images.reshape(train_images.shape[0], image_size, image_size, image_channels).astype('float16')
